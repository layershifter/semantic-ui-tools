...
export default class Visibility extends Component {
  ...
  fire = ({ callback, name }, value, reverse = false) => {
    ...
    const executionPossible =
      continuous || this.calculations[value] !== this.oldCalculations[value];
  ...
  update = () => {
    ...
    _.invoke(this.props, "onUpdate", null, {
      ...this.props,
  ...
  computeCalculations() {
    ...
    const bottomVisible =
      bottom >= bottomOffset && bottom <= window.innerHeight;
